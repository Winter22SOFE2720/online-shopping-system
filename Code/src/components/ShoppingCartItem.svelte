<script>
	...
	import { Button, IconButton, TextBox, NumberBox, TextBlock } from "fluent-svelte";
    ...
    let image = Object.assign({}, defaultimg, $$props?.image);
    export { image };
...
<div class="cart-item">
    ...
    <div class="content flex flex-col justify-between">
        <div class="header flex justify-between">
            ...
            <IconButton class="remove-btn" aria-label="Remove Item from Shopping Cart">
                <div class="icon">
